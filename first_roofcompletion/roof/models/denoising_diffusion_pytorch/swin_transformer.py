...
def swin_t(*, weights: Optional[Swin_T_Weights] = None, progress: bool = True,in_channels: int = 3, **kwargs: Any) -> SwinTransformer:
    """
...
def swin_s(*, weights: Optional[Swin_S_Weights] = None, progress: bool = True,in_channels: int = 3, **kwargs: Any) -> SwinTransformer:
    """
...
def swin_b(*, weights: Optional[Swin_B_Weights] = None, progress: bool = True,in_channels: int = 3, **kwargs: Any) -> SwinTransformer:
    """
