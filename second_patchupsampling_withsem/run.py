...
def main_worker(gpu, ngpus_per_node, opt):
    ...
    #             print("set {} to be trainable".format(name),"netG")
    #     if model.netG_EMA is not None:
    #         for name, param in model.netG_EMA.named_parameters():
    #             if "input_blocks" in name:
    #                 param.requires_grad = False
    #             else:
    #                 param.requires_grad = True
    #                 print("set {} to be trainable".format(name),"netG_ema")
